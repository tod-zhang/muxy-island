...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Analytics disabled in this fork. Replace the zeroed token with your
        // own Mixpanel project token if you want telemetry. Events sent with
        // this zero-token still format correctly but hit a nonexistent project
        // so they're silently discarded — nothing leaks anywhere.
        Mixpanel.initialize(token: "00000000000000000000000000000000")
